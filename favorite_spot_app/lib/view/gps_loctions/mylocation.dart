...
import 'package:keyboard_enter_app/model/musteatplace.dart';
...
class _MyLocationState extends State<MyLocation> {
  ...
  // Properties
  final MustEatPlaces _selectedSpot = Get.arguments[0];
  ...
  Widget flutterMap() {
    return FlutterMap(
        ...
        mapController: mapController,
        options: MapOptions(
            initialCenter: latlng.LatLng(_selectedSpot.lat, _selectedSpot.lng), // 초기 지도 중심 설정
        ...
        children: [
          ...
          MarkerLayer(markers: [
            Marker(
              width: 80,
              height: 80,
              point: latlng.LatLng(_selectedSpot.lat, _selectedSpot.lng), // 마커 위치 설정
              child: Column(
                children: [
                  Text(
                    _selectedSpot.name,
